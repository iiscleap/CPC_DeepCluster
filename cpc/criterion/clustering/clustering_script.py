...
if __name__ == "__main__":
    ...
    import os
    from cpc.feature_loader import loadModels, FeatureModule
    ...
    model = loadModels([args.pathCheckpoint], updateConfig=updateConfig)[0]
    ...
    if not os.path.exists(os.path.dirname(args.pathOutput)) and os.path.dirname(args.pathOutput):
        Path(os.path.dirname(args.pathOutput)).mkdir(
